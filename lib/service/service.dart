...
class ProductService {
  ...
  static String GET_SINGLE_API = 'products/';
  ...
  static Future<String?> GET_SINGLE(
  ...
  static Future<String> DELETEnew(
  ...
  static Map<String, String> paramsDELETEnew() {
  ...
  static Map<String, dynamic> paramsGetSingle() {
    Map<String, dynamic> params = {};
    return params;
  }
